...
const demoBookings = [
  {
    ...
    starters: ['bread'], client: 'John Smith', phone: '888-777-666', message: 'Chair for a baby',
  },
];
...
const BookingId = ({ match }) => {
  ...
  const [selectedDate, setSelectedDate] = useState(new Date(demoBookings[0].date));
  const handleDateChange = date => {
    setSelectedDate(date);
  };

  const [value, setValue] = React.useState({
    tableValue: demoBookings[0].table,
    guestValue: demoBookings[0].ppl,
    durationValue: demoBookings[0].duration,
    clientValue: demoBookings[0].client,
    phoneValue: demoBookings[0].phone,
    messageValue: demoBookings[0].message,
  });
              ...
              <Card>
                ...
                <FormGroup row>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        defaultChecked={demoBookings[0].starters.includes(demoStarters[0]) ?
                          true : state.checkedA
                        }
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        defaultChecked={demoBookings[0].starters.includes(demoStarters[1]) ?
                          true : state.checkedB}
